...
mod ERC20Component {
    ...
    use core::fmt::{Debug, DebugInteger, Error, Formatter};
    ...
    impl DebugFeltable<T, +Into<T, felt252>, +Copy<T>> of Debug<T> {
        fn fmt(self: @T, ref f: Formatter) -> Result<(), Error> {
            let as_felt: felt252 = self.clone().into();
            DebugInteger::<felt252>::fmt(@as_felt, ref f)
        }
    }
